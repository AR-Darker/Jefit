...
public class FriendsPage extends BasePage {
    ...
    public static final By FRIENDS_SPAN = By.xpath("//li[contains(text(),'Friend')]");
    ...
    public FriendsPage openMyFriends() {
        driver.get(BASE_URL + "my-jefit/friends.php");
        return this;
    }
    ...
    public void addNewFriend() {
        driver.findElement(SEARCH_FRIENDS_INPUT).sendKeys("mazzuste");
