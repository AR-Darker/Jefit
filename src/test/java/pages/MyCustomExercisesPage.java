...
@Log4j2
public class MyCustomExercisesPage extends BasePage {
    public MyCustomExercisesPage(WebDriver driver) {
        super(driver);
    }
    ...
    public MyCustomExercisesPage openMyCustomExercises() {
        driver.findElement(MY_CUSTOM_EXERCISES_TAB).click();
        log.info("Click on My Custom Exercise tab by " + MY_CUSTOM_EXERCISES_TAB);
        return new MyCustomExercisesPage(driver);
    }

    @Step("Create {customExercise}")
    public MyCustomExercisesPage createNewCustomExercise(CustomExercise customExercise) {
        ...
        int randomType1 = (int) (0 + Math.random()*typeGroup1);
        ...
        int randomType2 = (int) (0 + Math.random()*typeGroup2);;
        ...
        int randomType3 = (int) (0 + Math.random()*typeGroup3);
        ...
        int randomType4 = (int) (0 + Math.random()*typeGroup4);
    ...
    public MyCustomExercisesPage clickSave() {
    ...
    public MyCustomExercisesPage clickEdit() {
    ...
    public MyCustomExercisesPage clickDelete() {
